...
const translations = {
  pt: {
    ...
    newMemberDesc: "Insira os dados do novo membro para liberar o acesso ao sistema. Uma senha temporária será gerada e exibida ao criar; o membro deverá trocá-la no primeiro acesso.",
    save: "Cadastrar",
    cancel: "Cancelar",
  ...
  es: {
    ...
    newMemberDesc: "Ingrese los datos del nuevo miembro para habilitar su acceso. Se generará una contraseña temporal que se mostrará al crear; el miembro deberá cambiarla en el primer acceso.",
    save: "Registrar",
    cancel: "Cancelar",
    ...
    try {
      ...
      if (res.success) {
        ...
        if ((res as any).tempPassword) {
          toast.info(`Senha temporária de ${newEmail}: ${(res as any).tempPassword}`, { duration: 30000 });
        }
        setNewName("");
        setNewEmail("");
        setNewRole("OPERATOR");
